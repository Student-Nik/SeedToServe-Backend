...
public class ProductController {
	 ...
	 * 
	 * @RequestPart is designed for multipart/form-data where one part is JSON (your
	 * DTO) and the other part(s) are file(s).
	 * 
	 */
	...
	public ResponseEntity<Map<String, Object>> addProduct(@Valid @RequestPart("productDto") ProductDTO productDto,
		...
		try {
			...
			return ResponseEntity.status(HttpStatus.INTERNAL_SERVER_ERROR)
					.body(Map.of("message", "Error while processing image", "error", e.getMessage()));
	...
	public ResponseEntity<Map<String, Object>> updateProduct(@RequestPart ProductDTO productDto,
			@RequestPart(required = false) MultipartFile imageFile, @PathVariable String name) throws IOException {
