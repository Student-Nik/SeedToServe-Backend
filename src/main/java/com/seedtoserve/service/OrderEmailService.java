...
public class OrderEmailService {
	...
	public void sendOrderConfirmationEmail(Customer customer, Order order) {
		...
		String emailBody = """
				...
				""".formatted(customer.getFirstName(), order.getId(), orderDate, order.getPaymentMethod(),
				order.getPaymentStatus(), order.getOrderStatus(), order.getTotalAmount(), productRows.toString(),
